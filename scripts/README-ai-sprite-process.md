...
| `--mirror-cycle` | off | สร้างก้าวที่ 2 ด้วยภาพสะท้อน (flip แนวนอน) → **2× เฟรม (4 → 8)** เดินลื่น — ตัวไม่สมมาตร (รันเนอร์: ครีบหลัง) ห้ามใช้ |
...
| อยากได้ 8 เฟรมลื่นไหล | เพิ่ม `--mirror-cycle` | 4 ท่าหลัก → 8 เฟรม (ก้าว 2 = mirror) · manifest `frames: 8` + poseMap 8 ชื่อ · exit 0 |
